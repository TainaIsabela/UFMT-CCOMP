...
try:
    ...
    for j in range(0,20)
        ...
        #sorteio Planner
    #   browser.visit('https://www.instagram.com/p/CHqlG7ZAl45/')
    #   sleep(2)
    #   print(f'comentario numero: {i} Planner')
    #   browser.find_by_css('textarea[placeholder="Add a comment…"]').first.click()
    #   sleep(1)
    #   browser.find_by_css('textarea[placeholder="Add a comment…"]').fill('VOU GANHAR')
    #   sleep(1)
    #   browser.find_by_css('button[type="submit"]').first.click()
#       print(f'comentarios numero: {i} feito com sucesso')
